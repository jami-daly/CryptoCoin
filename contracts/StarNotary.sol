...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender, "You can't exchange the Star you don't own");
        address ownerFirstAddress = ownerOf(_tokenId1);
        address ownerSecondAddress = ownerOf(_tokenId2);
        _transferFrom(ownerFirstAddress, ownerSecondAddress, _tokenId1);
        _transferFrom(ownerSecondAddress, ownerFirstAddress, _tokenId2);
