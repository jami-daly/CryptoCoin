...
it('lets 2 users exchange stars', async() => {
    ...
    let user1 = accounts[1];
    let user2 = accounts[2];
    await instance.createStar('Awesome Star 1!',"Symbol", tokenId1, {from: user1});
    await instance.createStar('Awesome Star 2!',"Symbol", tokenId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let user1 = accounts[1];
    let user2 = accounts[2];
    await instance.createStar('Awesome Star 1!',"Symbol", tokenId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let tokenId = 10;
    let instance = await StarNotary.deployed();
    await instance.createStar('Awesome Star!',"Symbol", tokenId, {from: user1});
    assert.equal(await instance.tokenIdToStarInfo.call(tokenId), 'Awesome Star!')
});